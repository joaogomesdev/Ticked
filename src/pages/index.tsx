...
const Home: NextPage = () => {
  ...
  return (
    <Flex flexDir="column" width="full">
      ...
      {/* Create */}
      <Flex>
        <Image alt="" src="/Magic.svg" width="134px" height="282px" />

        <Flex mt={280} flexDirection="row">
          <Flex flexDirection="column" gap="10">
            ...
            >
              ...
              <span style={{ color: "#F7C325", fontWeight: "bold" }}>
                Customise the Information and visual identity. Your event, your
                rules!
              </span>
            </Text>
          </Flex>
        ...
        <Flex mt={280} flexDirection="row">
          ...
          <Flex flexDirection="column" gap="10">
            ...
            >
              ...
              <br />
              <br />
              Your can integrate the ticket generation with many providers such
              as Github, LinkedIn and many others.
              <br />
              <br />
              <span style={{ color: "#1AAE9F", fontWeight: "bold" }}>
                Improve your visitors ticket experiences by using what fits best
                for your business model. Your can create new custom tickets to
                you events.
              </span>
            </Text>
          </Flex>
      ...
      >
        ...
        >
          <Heading fontSize="48" color="whiteAlpha.900" fontWeight="medium">
            {"🎉"} Generate and{" "}
            <span style={{ color: "#F7C325", fontWeight: "bold" }}>enjoy</span>{" "}
            {"🎉"}
          </Heading>
          ...
          <Text
            ...
            color={colorMode === "light" ? "text.light" : "text.main"}
          >
            Your event visitors can generate their tickets in a simple and fast
            way.
            <br />
